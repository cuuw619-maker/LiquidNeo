...
public final class ReGlassClient {
    ...
    private static void onClientSetup(FMLClientSetupEvent event){
        event.enqueueWork(()->{
            ...
            ReGlassAnim.INSTANCE.update(restudio.reglass.client.api.ReGlassConfig.INSTANCE,0);
    ...
    private static void registerKeyMappings(RegisterKeyMappingsEvent event){
        ...
        event.register(playgroundKey); event.register(configKey);
    }
    ...
    private static void onClientTick(ClientTickEvent.Post event){
        ...
        if(configKey!=null&&configKey.consumeClick()) client.setScreen(new ReGlassConfigScreen(client.screen));
        if(playgroundKey!=null&&playgroundKey.consumeClick()) client.setScreen(new PlaygroundScreen());
    }
}
