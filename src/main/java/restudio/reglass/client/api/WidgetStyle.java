...
public class WidgetStyle {
    ...
    private float refThickness, refFactor, refDispersion, refFresnelRange, refFresnelHardness, refFresnelFactor;
    private boolean hasGlare;
    private float glareRange, glareHardness, glareConvergence, glareOppositeFactor, glareFactor, glareAngleRad;
    ...
    public WidgetStyle smoothing(float factor) { hasSmoothing=true; smoothingFactor=factor; return this; }
    public WidgetStyle blurRadius(int radius) { hasBlurRadius=true; blurRadius=Math.max(0,radius); return this; }
    public WidgetStyle shadow(float expand,float factor,float offsetX,float offsetY) { hasShadow=true; shadowExpand=expand; shadowFactor=factor; shadowOffsetX=offsetX; shadowOffsetY=offsetY; return this; }
    public WidgetStyle shadowColor(int color,float alpha) { hasShadow=true; shadowColor=color; shadowColorAlpha=alpha; return this; }
